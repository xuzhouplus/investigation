...
class DivideTemplate extends ExcelTemplate
{
	public function run()
	{
		...
		$this->setHeadContent([
			...
			['content' => '品牌记忆4', 'fontName' => '微软雅黑', 'fontSize' => 9, 'horizontalAlign' => 'center', 'fontBold' => true, 'bgColor' => 'FFFFFF'],
			['content' => '品牌记忆5', 'fontName' => '微软雅黑', 'fontSize' => 9, 'horizontalAlign' => 'center', 'fontBold' => true, 'bgColor' => 'FFFFFF'],
			...
			['content' => '用户名', 'fontName' => '微软雅黑', 'fontSize' => 9, 'horizontalAlign' => 'center', 'fontBold' => true, 'bgColor' => 'FFFFFF'],
			['content' => '用户邮箱', 'fontName' => '微软雅黑', 'fontSize' => 9, 'horizontalAlign' => 'center', 'fontBold' => true, 'bgColor' => 'FFFFFF'],
			['content' => '性别', 'fontName' => '微软雅黑', 'fontSize' => 9, 'horizontalAlign' => 'center', 'fontBold' => true, 'bgColor' => 'FFFFFF'],
		...
		$this->setBodyContent([
			...
			['content' => 'brandMemory4'],
			['content' => 'brandMemory5'],
